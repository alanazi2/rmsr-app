...
const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-zinc-900 text-white flex items-center justify-center">
      <div className="container mx-auto px-4 py-20 grid gap-12 lg:grid-cols-2 items-center">
        {/* Profile Image */}
        <motion.div
        ...
        <motion.div
          ...
          className="space-y-8"
        >
          <h2 className="text-2xl font-medium tracking-wider text-zinc-400">ABOUT ME</h2>
          <p className="text-4xl font-light leading-relaxed">
            An independent digital designer and front-end developer. Passionate
            about crafting unforgettable experiences and providing companies with
            innovative, user-centric solutions for nearly a decade.
          </p>
          ...
          <div className="grid grid-cols-3 gap-6 pt-8">
            {[
              ...
              <motion.div
                ...
                className="p-6 rounded-2xl bg-zinc-800/50 backdrop-blur-sm text-center"
              >
